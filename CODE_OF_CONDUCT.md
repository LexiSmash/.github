...
This Code of Conduct applies within all spaces of the LexiSmash GitHub organization (all repositories, Issues, Pull Requests, Discussions), and also applies when an individual is officially representing the community in public spaces, such as using an official e-mail address or posting via an official social media account.
